      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.container}>
            <p className={styles.eyebrow}>Business Solutions</p>
            <h1 className={styles.title}>Upskill Teams With Measurable Business Impact</h1>
            ...
            <div className={styles.actions}>
              ...
              <Link href={`/${locale}/b2b-dashboard`}>
                <Button variant="secondary" size="md">Open B2B Dashboard</Button>
              </Link>
            </div>
          </div>
        </section>
